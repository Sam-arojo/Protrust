                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-1.5">
                      ...
                      {result.productInfo?.manufacturingDate && (
                        <p className="text-sm text-green-800">
                          <span className="font-medium">Mfg. Date:</span> {new Date(result.productInfo.manufacturingDate).toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' })}
                        </p>
                      )}
                      {result.productInfo?.expiringDate && (
                        <p className="text-sm text-green-800">
                          <span className="font-medium">Exp. Date:</span> {new Date(result.productInfo.expiringDate).toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' })}
                        </p>
                      )}
                    </div>
                  </div>
